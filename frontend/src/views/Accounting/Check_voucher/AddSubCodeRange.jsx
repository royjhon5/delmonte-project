...
const AddSubCodeRange = ({open, onClose, Data}) => {
  ...
  const getData = async () => {
    setLoading(true)
    try {
      const response = await http.get('/sub-codes-range')
...
AddSubCodeRange.propTypes = {
    onClose: PropTypes.func,
    open: PropTypes.bool,
    Data: PropTypes.func,
}

export default AddSubCodeRange