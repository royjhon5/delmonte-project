...
const PayrollData = () => {
    const documentType = "Miscellaneous/Others";
    ...
    const { data: subDocList } = hookContainer('get-sub-document-type', { DocType_IDLink: 4 });
    ...
    const initialDataVariable = {
        id: "",
        DocTypeLinkID: 4, // other Documents 
        DocReferenceID: "MO" + getDateNow('year') + getDateNow('month'),
        DVNo: "",
        DVDate: "",
        JEVNo: "",
        ORSNo: "",
        ...
        try {
            ...
            if (saveDataResponse.data.success) {
                await http.post('/add-audit-log', {
                    ...
                    interface: "Upload Miscellaneous/Others"
                }); // save audit log
    ...
    const processImage = () => {
        setProgress(0);
        Tesseract.recognize(attachFile, "eng", {
            logger: (m) => {
            ...
            <Grid container spacing={1}>
                <Grid item xs={12} md={6}>
                    <Paper sx={{ padding: 2, display: 'flex', flexDirection: 'column', gap: 1 }}>
                        ...
                        <TextField variant="filled" size="small" label="Document Category" select value={dataVariable.category} onChange={updateDataVariable} name="category" SelectProps={{ native: true, }} fullWidth>
                            <option></option>
                            <option>Incoming</option>
                            <option>Outgoing</option>
                            <option>Within Office</option>
                        </TextField>
                        <Grid container spacing={1}>
                            <Grid item xs={12} md={6}>
                        ...
                        <Grid container spacing={1}>
                            <Grid item xs={12} md={6}>
                                {dataVariable.category == 'Outgoing' ?
                                    <TextField variant="filled" type="date" fullWidth size="small" label="Date Sent" value={dataVariable.DateSent} onChange={updateDataVariable} name="DateSent" InputLabelProps={{ shrink: true }} /> :
                            ...
                            <Grid item xs={12} md={6}>
                                <TextField variant="filled" fullWidth size="small" label="Address To" value={dataVariable.personnelName} onChange={updateDataVariable} name="personnelName" />
                            </Grid>
                        </Grid>
