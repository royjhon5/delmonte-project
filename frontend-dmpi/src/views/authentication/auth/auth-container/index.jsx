...
import GSMPCTheme from '../../../../assets/images/backdraft.jpg'
  ...
  return (
    <Fragment>
        ...
        >
           {!isMobile && (
              <>
                <Box component="img" src={GSMPCTheme} alt="Login" sx={{ maxWidth: isSmallScreen ? '80%' : '100%', height: { xs: 'auto' , xl: '100%'},}}></Box>
              </>
           )}
        </Grid>
