...
import AddModal from "./AddSignatory";
...
const SignatoryData = () => {
    ...
    const ColumnHeader = [
        {
            field: 'name', headerName: 'Signatory Name', flex:1,
            renderCell: (data) => (
    ...
    const refreshData = () => queryClient.invalidateQueries(['/get-signatory']);
        ...
        <>
            ...
            <Paper>
                <Stack sx={{ display: 'flex', padding: '20px', flexDirection: 'row', justifyContent: 'space-between' }}>
                    ...
                    <Button variant="contained" onClick={openAddFieldListModal}>Add Signatory</Button>
                </Stack>
                <CustomDataGrid
