...
const GLCodeData = () => {
    ...
    const { data: mainData } = hookContainer('/get-glcode');
    ...
    const openAddGLCodeModal = () => {
        dispatch({ type: OPEN_CUSTOM_MODAL, openCustomModal: true });
    }

    const refreshData = () => queryClient.invalidateQueries(['/get-glcode']);
    ...
    const deleteData = useMutation({
        mutationFn: () => http.delete(`/remove-glcode?id=${selectedID}`),
        onSuccess: () => {
