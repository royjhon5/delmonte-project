...
const VerifyPeriodStatus = ({onClose, open, maxWidth, YesOnClick, NoOnClick, statusTitle}) => {
  ...
  return (
    ...
    sx={{
      ...
      <DialogTitle>Confirm Change of Status.</DialogTitle>
      <DialogContent
      sx={{ 
        flex: '1 1 auto',
        overflowY: 'auto', 
      ...
      >
        ...
        Are you sure you want to {statusTitle} the status on this data?
        </Box>
      </DialogContent>
      <DialogActions 
            sx={{ 
...
VerifyPeriodStatus.propTypes = {
    ...
    statusTitle: PropTypes.node,
  }

export default VerifyPeriodStatus