...
import WelComeWomen from '../../../assets/images/character_3.png'
    ...
    >
      <defs>
        <linearGradient
          ...
          y2="16.69%"
        >
          <stop offset="0%" stopColor={`${color.svgcolor[200]}`}></stop>
          <stop offset="100%" stopColor={`${color.svgcolor[200]}`} stopOpacity="0"></stop>
        </linearGradient>
        ...
        >
          <stop stopColor={`${color.svgcolor[400]}`}></stop>
          <stop offset="1" stopColor={`${color.svgcolor[500]}`}></stop>
        </linearGradient>
        <linearGradient
        ...
        <linearGradient x1="19.496%" x2="77.479%" y1="71.822%" y2="16.69%">
          <stop offset="0%"  stopColor={`${color.svgcolor[400]}`}></stop>
          <stop offset="100%" stopColor={`${color.svgcolor[500]}`} stopOpacity="0"></stop>
        </linearGradient>
        <linearGradient
          x1="47.397"
          x2="47.397"
        ...
        <linearGradient x1="19.496%" x2="77.479%" y1="71.822%" y2="16.69%">
          <stop offset="0%" stopColor={`${color.svgcolor[400]}`}></stop>
          <stop offset="100%" stopColor={`${color.svgcolor[500]}`}></stop>
        </linearGradient>
        <linearGradient
          x1="47.397"
          x2="47.397"
      ...
      <path
        ...
        d="M170.575 276.06l-62.558 5.295a11.4 11.4 0 01-11.785-7.805l-48.29-150.979a11.028 11.028 0 01-.546-3.278A11.34 11.34 0 0158.74 107.95h57.453l54.382 168.11z"
      ></path>
      <path
        fill="#F4F6F8"
      ...
      <path
        fill="#FFF"
        fillRule="evenodd"
        d="M78.02 155.171a15.22 15.22 0 11.312 1.015l-.156-.495-.157-.52zm15.194-4.189l-3.59-11.525a12.641 12.641 0 013.121-.547 12.102 12.102 0 0111.994 8.456c.312 1.014.496 2.062.546 3.122a13.006 13.006 0 01-.286 3.148 11.815 11.815 0 01-2.914 5.516 11.914 11.914 0 01-11.525 3.59 13.21 13.21 0 01-2.94-1.067 12.76 12.76 0 01-2.602-1.821 12.257 12.257 0 01-3.33-5.203l11.526-3.669zm18.082 100.791a15.298 15.298 0 0129.321-8.429v.494c0 .156 0 .338.182.494a15.272 15.272 0 01-28.619 10.407c-.078-.247-.149-.495-.221-.742a28.499 28.499 0 00-.221-.741 16.041 16.041 0 01-.171-.595 10.734 10.734 0 00-.271-.888zm11.187-14.7l3.746 11.474.079-.026 3.746 11.5a11.965 11.965 0 006.921-6.01 11.83 11.83 0 001.04-2.966c.23-1.024.317-2.075.26-3.122a12.07 12.07 0 00-9.548-11.188 12.42 12.42 0 00-6.244.338zm-22.273-49.564a15.272 15.272 0 00-4.473 10.799v1.066a15.272 15.272 0 1030.544 0v-1.066a15.271 15.271 0 00-26.071-10.799zm10.591 11.293V186.73c2.112.016 4.183.581 6.01 1.639a11.366 11.366 0 012.602 1.925 12.027 12.027 0 01-.005 17.068 12.022 12.022 0 01-5.433 3.096 11.575 11.575 0 01-6.244 0 12.202 12.202 0 01-2.914-1.171l5.984-10.485z"
        clipRule="evenodd"
        opacity="0.4"
      ></path>
      <path
      ...
      <path
        fill={`${color.svgcolor[500]}`}
        d="M117.435 95.279l7.051-6.947L151.154 76l-33.719 19.28z"
      ></path>
      <path
        fill={`${color.svgcolor[500]}`}
      ...
      <image xlinkHref={WelComeWomen} height="300" x="312" y="30" />
    </svg>
      </Box>
    </>
  )
